...
public class ScienceFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) getActivity().findViewById(R.id.recycler_science);

        refreshLayout = (RefreshLayout) getActivity().findViewById(R.id.refreshLayout_Science);
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(@NonNull RefreshLayout refreshLayout) {
                ...
                apiGetList = new ApiGetList("https://api.jakting.com/v1/news/netease/?num=0&type=science", myHandler);
            }
        });
        refreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(RefreshLayout refreshlayout) {
                ...
                ++page;
                apiGetList = new ApiGetList("https://api.jakting.com/v1/news/netease/?num="+page+"&type=science", myHandler);
