...
public class DigitalFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) getActivity().findViewById(R.id.recycler_digital);

        refreshLayout = (RefreshLayout) getActivity().findViewById(R.id.refreshLayout_Digital);
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(@NonNull RefreshLayout refreshLayout) {
                ...
                apiGetList = new ApiGetList("https://api.jakting.com/v1/news/netease/?num=0&type=digital", myHandler);
            }
        });
        refreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(RefreshLayout refreshlayout) {
                ...
                ++page;
                apiGetList = new ApiGetList("https://api.jakting.com/v1/news/netease/?num="+page+"&type=digital", myHandler);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        digitalViewModel =
                ViewModelProviders.of(this).get(DigitalViewModel.class);
        View root = inflater.inflate(R.layout.fragment_digital, container, false);
